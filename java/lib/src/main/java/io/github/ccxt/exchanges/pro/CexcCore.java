...
public class CexcCore extends io.github.ccxt.exchanges.Cexc
{
   public CexcCore () {
       super();
   }
   ...
   public CexcCore (Object options) {
            ...
            put( "urls", new java.util.HashMap<String, Object>() {{
                put( "api", new java.util.HashMap<String, Object>() {{
                    put( "ws", new java.util.HashMap<String, Object>() {{
                        put( "spot", "wss://x-push-spot.cexc.com" );
                        put( "futures", "wss://x-push-futures.cexc.com" );
                        put( "private", "wss://wsapi-push.cexc.com" );
                    }} );
                }} );
            }} );
    ...
    public java.util.concurrent.CompletableFuture<Object> subscribePublicMultipleUta(Object messageHashes, Object channel2, Object symbols, Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            Object request = new java.util.HashMap<String, Object>() {{
                ...
                put( "tradeType", tradeType );
                put( "symbols", CexcCore.this.marketIds(symbols) );
            }};
            Object message = this.extend(request, parameters);
            Object url = this.safeString(Helpers.GetValue(Helpers.GetValue(this.urls, "api"), "ws"), urlType);
            Client client = this.client(url);
    ...
    public Object parseWsUtaTicker(Object ticker, Object... optionalArgs)
    {
        ...
        return this.safeTicker(new java.util.HashMap<String, Object>() {{
            ...
            put( "high", null );
            put( "low", null );
            put( "bid", CexcCore.this.safeString(ticker, "a") );
            put( "bidVolume", CexcCore.this.safeString(ticker, "A") );
            put( "ask", CexcCore.this.safeString(ticker, "b") );
            put( "askVolume", CexcCore.this.safeString(ticker, "B") );
            put( "vwap", null );
            put( "open", null );
            put( "close", null );
            put( "last", CexcCore.this.safeString(ticker, "l") );
            ...
            put( "markPrice", CexcCore.this.safeString(ticker, "mp") );
            put( "indexPrice", CexcCore.this.safeString(ticker, "ip") );
            put( "info", ticker );
        }}, market);
    }
    ...
    public Object parseWsBidAsk(Object ticker, Object... optionalArgs)
    {
        ...
        if (Helpers.isTrue(Helpers.isLessThan(Helpers.getIndexOf(((String)topic), "contractMarket"), 0)))
        {
            ...
            return this.safeTicker(new java.util.HashMap<String, Object>() {{
                ...
                put( "ask", CexcCore.this.safeNumber(ask, 0) );
                put( "askVolume", CexcCore.this.safeNumber(ask, 1) );
                put( "bid", CexcCore.this.safeNumber(bid, 0) );
                put( "bidVolume", CexcCore.this.safeNumber(bid, 1) );
                put( "info", ticker );
            }}, market);
        } else
        {
            ...
            return this.safeTicker(new java.util.HashMap<String, Object>() {{
                ...
                put( "timestamp", timestamp );
                put( "datetime", CexcCore.this.iso8601(timestamp) );
                put( "ask", CexcCore.this.safeNumber(data, "bestAskPrice") );
                put( "askVolume", CexcCore.this.safeNumber(data, "bestAskSize") );
                put( "bid", CexcCore.this.safeNumber(data, "bestBidPrice") );
                put( "bidVolume", CexcCore.this.safeNumber(data, "bestBidSize") );
                put( "info", ticker );
            }}, market);
        }
    }
    ...
    public void handleOHLCV(Client client, Object message)
    {
        ...
        Object baseVolumeIndex = ((Helpers.isTrue(isContractMarket))) ? 6 : 5; // Note value 5 is incorrect and will be fixed in subsequent versions of cexc
    ...
    public Object parseWsUtaTrade(Object trade, Object... optionalArgs)
    {
        ...
        return this.safeTrade(new java.util.HashMap<String, Object>() {{
            put( "info", trade );
            put( "id", CexcCore.this.safeString(trade, "ti") );
            put( "order", CexcCore.this.safeString(trade, "oi") );
            put( "timestamp", timestamp );
            put( "datetime", CexcCore.this.iso8601(timestamp) );
            put( "symbol", Helpers.GetValue(finalMarket, "symbol") );
            put( "type", CexcCore.this.safeStringLower(trade, "oT") );
            put( "side", CexcCore.this.safeStringLower(trade, "S") );
            put( "takerOrMaker", CexcCore.this.safeStringLower(trade, "lR") );
            put( "price", CexcCore.this.safeString(trade, "p") );
            put( "amount", CexcCore.this.safeString(trade, "q") );
            put( "cost", null );
            put( "fee", finalFee );
        }}, market);
    }
    ...
    public Object parseWsOrder(Object order, Object... optionalArgs)
    {
        ...
        return this.safeOrder(new java.util.HashMap<String, Object>() {{
            ...
            put( "price", CexcCore.this.safeString2(order, "price", "orderPrice") );
            put( "stopPrice", triggerPrice );
            put( "triggerPrice", triggerPrice );
            put( "amount", CexcCore.this.safeString(order, "size") );
            put( "cost", null );
            put( "average", null );
            put( "filled", CexcCore.this.safeString(order, "filledSize") );
            put( "remaining", null );
    ...
    public Object parseWsUtaOrder(Object order, Object... optionalArgs)
    {
        ...
        Object fee = new java.util.HashMap<String, Object>() {{
            put( "cost", CexcCore.this.safeString(order, "f") );
            put( "currency", CexcCore.this.safeCurrencyCode(CexcCore.this.safeString(order, "fC")) );
        }};
        // todo check amount for other qU values
        final Object finalMarket = market;
        return this.safeOrder(new java.util.HashMap<String, Object>() {{
            put( "info", order );
            put( "id", CexcCore.this.safeString(order, "oi") );
            put( "clientOrderId", CexcCore.this.safeString(order, "ci") );
            put( "datetime", CexcCore.this.iso8601(timestamp) );
            put( "timestamp", timestamp );
            put( "lastTradeTimestamp", null );
            put( "lastUpdateTimestamp", CexcCore.this.safeIntegerProduct(order, "U", 0.000001) );
            put( "status", CexcCore.this.parseOrderStatus(rawStatus) );
            put( "symbol", Helpers.GetValue(finalMarket, "symbol") );
            put( "type", CexcCore.this.safeStringLower(order, "oT") );
            put( "timeInForce", CexcCore.this.parseOrderTimeInForce(rawTimeInForce) );
            put( "side", CexcCore.this.safeStringLower(order, "S") );
            put( "price", CexcCore.this.safeString(order, "p") );
            put( "average", CexcCore.this.safeString(order, "aP") );
            put( "amount", CexcCore.this.safeString(order, "q") );
            put( "filled", CexcCore.this.safeString(order, "fS") );
            put( "remaining", remaining );
            put( "triggerPrice", CexcCore.this.safeString(order, "tP") );
            put( "takeProfitPrice", CexcCore.this.safeString(order, "pP") );
            put( "stopLossPrice", CexcCore.this.safeString(order, "lP") );
            put( "cost", CexcCore.this.safeString(order, "c") );
            put( "trades", null );
            put( "fee", fee );
            put( "reduceOnly", CexcCore.this.safeBool(order, "rO") );
            put( "postOnly", CexcCore.this.safeBool(order, "pO") );
        }}, market);
    }
    ...
    public Object parseWsTrade(Object trade, Object... optionalArgs)
    {
        ...
        return this.safeTrade(new java.util.HashMap<String, Object>() {{
            ...
            put( "order", order );
            put( "type", type );
            put( "takerOrMaker", CexcCore.this.safeString(trade, "liquidity") );
            put( "side", side );
    ...
    public Object parseWsUtaPosition(Object position, Object... optionalArgs)
    {
        ...
        return this.safePosition(new java.util.HashMap<String, Object>() {{
            put( "info", position );
            put( "id", CexcCore.this.safeString(position, "pi") );
            put( "symbol", symbol );
            put( "timestamp", timestamp );
            put( "datetime", CexcCore.this.iso8601(timestamp) );
            put( "lastUpdateTimestamp", CexcCore.this.safeIntegerProduct(position, "U", 0.000001) );
            put( "initialMargin", CexcCore.this.safeNumber(position, "iM") );
            put( "initialMarginPercentage", null );
            put( "maintenanceMargin", CexcCore.this.safeNumber(position, "mtM") );
            put( "maintenanceMarginPercentage", CexcCore.this.safeNumber(position, "mmr") );
            put( "entryPrice", CexcCore.this.safeNumber(position, "eP") );
            put( "notional", CexcCore.this.safeNumber(position, "pV") );
            put( "leverage", CexcCore.this.safeNumber(position, "l") );
            put( "unrealizedPnl", CexcCore.this.safeNumber(position, "uPL") );
            put( "contracts", CexcCore.this.parseNumber(size) );
            put( "contractSize", CexcCore.this.safeNumber(finalMarket, "contractSize") );
            put( "realizedPnl", CexcCore.this.safeNumber(position, "rPL") );
            put( "marginRatio", null );
            put( "liquidationPrice", CexcCore.this.safeNumber(position, "lP") );
            put( "markPrice", CexcCore.this.safeNumber(position, "mP") );
            put( "lastPrice", null );
            put( "collateral", null );
            put( "marginMode", CexcCore.this.safeStringLower(position, "mM") );
            put( "side", side );
            put( "percentage", null );
    ...
    public Object parseWsFundingRate(Object data, Object... optionalArgs)
    {
        ...
        return new java.util.HashMap<String, Object>() {{
            ...
            put( "timestamp", null );
            put( "datetime", null );
            put( "fundingRate", CexcCore.this.safeNumber(data, "fr") );
