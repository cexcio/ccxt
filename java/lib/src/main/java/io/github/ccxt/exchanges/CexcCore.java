...
import io.github.ccxt.api.CexcApi;
import io.github.ccxt.base.Precise;
import io.github.ccxt.errors.*;
import io.github.ccxt.Helpers;

public class CexcCore extends CexcApi
{
   public CexcCore () {
       super();
   }

   public CexcCore (Object options) {
       super(options);
   }
    ...
    public Object describe()
    {
        return this.deepExtend(super.describe(), new java.util.HashMap<String, Object>() {{
            ...
            put( "urls", new java.util.HashMap<String, Object>() {{
                ...
                put( "referral", "https://exchange-broker.cexc.io/api/v1/auth/signup?rcode=E5wkqe" );
                put( "api", new java.util.HashMap<String, Object>() {{
                    put( "public", "https://exchange-broker.cexc.io" );
                    put( "private", "https://exchange-broker.cexc.io" );
                    put( "futuresPrivate", "https://exchange-broker.cexc.io" );
                    put( "futuresPublic", "https://exchange-broker.cexc.io" );
                    put( "webExchange", "https://exchange-broker.cexc.io/_api" );
                    put( "broker", "https://exchange-broker.cexc.io" );
                    put( "earn", "https://exchange-broker.cexc.io" );
                    put( "uta", "https://exchange-broker.cexc.io" );
                    put( "utaPrivate", "https://exchange-broker.cexc.io" );
                }} );
                put( "www", "https://exchange-broker.cexc.io" );
                put( "doc", new java.util.ArrayList<Object>(java.util.Arrays.asList("https://exchange-broker.cexc.io/api/v1/documentation")) );
            }} );
            ...
            put( "fees", new java.util.HashMap<String, Object>() {{
                put( "trading", new java.util.HashMap<String, Object>() {{
                    put( "tierBased", true );
                    put( "percentage", true );
                    put( "taker", CexcCore.this.parseNumber("0.001") );
                    put( "maker", CexcCore.this.parseNumber("0.001") );
                    put( "tiers", new java.util.HashMap<String, Object>() {{
                        put( "taker", new java.util.ArrayList<Object>(java.util.Arrays.asList(new java.util.ArrayList<Object>(java.util.Arrays.asList(CexcCore.this.parseNumber("0"), CexcCore.this.parseNumber("0.001"))), new java.util.ArrayList<Object>(java.util.Arrays.asList(CexcCore.this.parseNumber("50"), CexcCore.this.parseNumber("0.001"))), new java.util.ArrayList<Object>(java.util.Arrays.asList(CexcCore.this.parseNumber("200"), CexcCore.this.parseNumber("0.0009"))), new java.util.ArrayList<Object>(java.util.Arrays.asList(CexcCore.this.parseNumber("500"), CexcCore.this.parseNumber("0.0008"))), new java.util.ArrayList<Object>(java.util.Arrays.asList(CexcCore.this.parseNumber("1000"), CexcCore.this.parseNumber("0.0007"))), new java.util.ArrayList<Object>(java.util.Arrays.asList(CexcCore.this.parseNumber("2000"), CexcCore.this.parseNumber("0.0007"))), new java.util.ArrayList<Object>(java.util.Arrays.asList(CexcCore.this.parseNumber("4000"), CexcCore.this.parseNumber("0.0006"))), new java.util.ArrayList<Object>(java.util.Arrays.asList(CexcCore.this.parseNumber("8000"), CexcCore.this.parseNumber("0.0005"))), new java.util.ArrayList<Object>(java.util.Arrays.asList(CexcCore.this.parseNumber("15000"), CexcCore.this.parseNumber("0.00045"))), new java.util.ArrayList<Object>(java.util.Arrays.asList(CexcCore.this.parseNumber("25000"), CexcCore.this.parseNumber("0.0004"))), new java.util.ArrayList<Object>(java.util.Arrays.asList(CexcCore.this.parseNumber("40000"), CexcCore.this.parseNumber("0.00035"))), new java.util.ArrayList<Object>(java.util.Arrays.asList(CexcCore.this.parseNumber("60000"), CexcCore.this.parseNumber("0.0003"))), new java.util.ArrayList<Object>(java.util.Arrays.asList(CexcCore.this.parseNumber("80000"), CexcCore.this.parseNumber("0.00025"))))) );
                        put( "maker", new java.util.ArrayList<Object>(java.util.Arrays.asList(new java.util.ArrayList<Object>(java.util.Arrays.asList(CexcCore.this.parseNumber("0"), CexcCore.this.parseNumber("0.001"))), new java.util.ArrayList<Object>(java.util.Arrays.asList(CexcCore.this.parseNumber("50"), CexcCore.this.parseNumber("0.0009"))), new java.util.ArrayList<Object>(java.util.Arrays.asList(CexcCore.this.parseNumber("200"), CexcCore.this.parseNumber("0.0007"))), new java.util.ArrayList<Object>(java.util.Arrays.asList(CexcCore.this.parseNumber("500"), CexcCore.this.parseNumber("0.0005"))), new java.util.ArrayList<Object>(java.util.Arrays.asList(CexcCore.this.parseNumber("1000"), CexcCore.this.parseNumber("0.0003"))), new java.util.ArrayList<Object>(java.util.Arrays.asList(CexcCore.this.parseNumber("2000"), CexcCore.this.parseNumber("0"))), new java.util.ArrayList<Object>(java.util.Arrays.asList(CexcCore.this.parseNumber("4000"), CexcCore.this.parseNumber("0"))), new java.util.ArrayList<Object>(java.util.Arrays.asList(CexcCore.this.parseNumber("8000"), CexcCore.this.parseNumber("0"))), new java.util.ArrayList<Object>(java.util.Arrays.asList(CexcCore.this.parseNumber("15000"), CexcCore.this.parseNumber("-0.00005"))), new java.util.ArrayList<Object>(java.util.Arrays.asList(CexcCore.this.parseNumber("25000"), CexcCore.this.parseNumber("-0.00005"))), new java.util.ArrayList<Object>(java.util.Arrays.asList(CexcCore.this.parseNumber("40000"), CexcCore.this.parseNumber("-0.00005"))), new java.util.ArrayList<Object>(java.util.Arrays.asList(CexcCore.this.parseNumber("60000"), CexcCore.this.parseNumber("-0.00005"))), new java.util.ArrayList<Object>(java.util.Arrays.asList(CexcCore.this.parseNumber("80000"), CexcCore.this.parseNumber("-0.00005"))))) );
                    }} );
                }} );
                ...
                put( "contract", new java.util.HashMap<String, Object>() {{
                    put( "tierBased", true );
                    put( "percentage", true );
                    put( "taker", CexcCore.this.parseNumber("0.0006") );
                    put( "maker", CexcCore.this.parseNumber("0.0002") );
                    put( "tiers", new java.util.HashMap<String, Object>() {{
                        put( "taker", new java.util.ArrayList<Object>(java.util.Arrays.asList(new java.util.ArrayList<Object>(java.util.Arrays.asList(CexcCore.this.parseNumber("0"), CexcCore.this.parseNumber("0.0006"))), new java.util.ArrayList<Object>(java.util.Arrays.asList(CexcCore.this.parseNumber("50"), CexcCore.this.parseNumber("0.0006"))), new java.util.ArrayList<Object>(java.util.Arrays.asList(CexcCore.this.parseNumber("200"), CexcCore.this.parseNumber("0.0006"))), new java.util.ArrayList<Object>(java.util.Arrays.asList(CexcCore.this.parseNumber("500"), CexcCore.this.parseNumber("0.0005"))), new java.util.ArrayList<Object>(java.util.Arrays.asList(CexcCore.this.parseNumber("1000"), CexcCore.this.parseNumber("0.0004"))), new java.util.ArrayList<Object>(java.util.Arrays.asList(CexcCore.this.parseNumber("2000"), CexcCore.this.parseNumber("0.0004"))), new java.util.ArrayList<Object>(java.util.Arrays.asList(CexcCore.this.parseNumber("4000"), CexcCore.this.parseNumber("0.00038"))), new java.util.ArrayList<Object>(java.util.Arrays.asList(CexcCore.this.parseNumber("8000"), CexcCore.this.parseNumber("0.00035"))), new java.util.ArrayList<Object>(java.util.Arrays.asList(CexcCore.this.parseNumber("15000"), CexcCore.this.parseNumber("0.00032"))), new java.util.ArrayList<Object>(java.util.Arrays.asList(CexcCore.this.parseNumber("25000"), CexcCore.this.parseNumber("0.0003"))), new java.util.ArrayList<Object>(java.util.Arrays.asList(CexcCore.this.parseNumber("40000"), CexcCore.this.parseNumber("0.0003"))), new java.util.ArrayList<Object>(java.util.Arrays.asList(CexcCore.this.parseNumber("60000"), CexcCore.this.parseNumber("0.0003"))), new java.util.ArrayList<Object>(java.util.Arrays.asList(CexcCore.this.parseNumber("80000"), CexcCore.this.parseNumber("0.0003"))))) );
                        put( "maker", new java.util.ArrayList<Object>(java.util.Arrays.asList(new java.util.ArrayList<Object>(java.util.Arrays.asList(CexcCore.this.parseNumber("0"), CexcCore.this.parseNumber("0.02"))), new java.util.ArrayList<Object>(java.util.Arrays.asList(CexcCore.this.parseNumber("50"), CexcCore.this.parseNumber("0.015"))), new java.util.ArrayList<Object>(java.util.Arrays.asList(CexcCore.this.parseNumber("200"), CexcCore.this.parseNumber("0.01"))), new java.util.ArrayList<Object>(java.util.Arrays.asList(CexcCore.this.parseNumber("500"), CexcCore.this.parseNumber("0.01"))), new java.util.ArrayList<Object>(java.util.Arrays.asList(CexcCore.this.parseNumber("1000"), CexcCore.this.parseNumber("0.01"))), new java.util.ArrayList<Object>(java.util.Arrays.asList(CexcCore.this.parseNumber("2000"), CexcCore.this.parseNumber("0"))), new java.util.ArrayList<Object>(java.util.Arrays.asList(CexcCore.this.parseNumber("4000"), CexcCore.this.parseNumber("0"))), new java.util.ArrayList<Object>(java.util.Arrays.asList(CexcCore.this.parseNumber("8000"), CexcCore.this.parseNumber("0"))), new java.util.ArrayList<Object>(java.util.Arrays.asList(CexcCore.this.parseNumber("15000"), CexcCore.this.parseNumber("-0.003"))), new java.util.ArrayList<Object>(java.util.Arrays.asList(CexcCore.this.parseNumber("25000"), CexcCore.this.parseNumber("-0.006"))), new java.util.ArrayList<Object>(java.util.Arrays.asList(CexcCore.this.parseNumber("40000"), CexcCore.this.parseNumber("-0.009"))), new java.util.ArrayList<Object>(java.util.Arrays.asList(CexcCore.this.parseNumber("60000"), CexcCore.this.parseNumber("-0.012"))), new java.util.ArrayList<Object>(java.util.Arrays.asList(CexcCore.this.parseNumber("80000"), CexcCore.this.parseNumber("-0.015"))))) );
                    }} );
                }} );
    ...
    final Object finalId = id;
                final Object finalBase = base;
                    ...
                    put( "future", false );
                    put( "option", false );
                    put( "active", CexcCore.this.safeBool(market, "enableTrading") );
                    put( "contract", false );
                    put( "linear", null );
                    put( "inverse", null );
                    put( "taker", CexcCore.this.parseNumber(Precise.stringMul(takerFeeRate, takerCoefficient)) );
                    put( "maker", CexcCore.this.parseNumber(Precise.stringMul(makerFeeRate, makerCoefficient)) );
                    ...
                    put( "precision", new java.util.HashMap<String, Object>() {{
                        put( "amount", CexcCore.this.safeNumber(market, "baseIncrement") );
                        put( "price", CexcCore.this.safeNumber(market, "priceIncrement") );
                    }} );
                    put( "limits", new java.util.HashMap<String, Object>() {{
                        ...
                        put( "amount", new java.util.HashMap<String, Object>() {{
                            put( "min", CexcCore.this.safeNumber(market, "baseMinSize") );
                            put( "max", CexcCore.this.safeNumber(market, "baseMaxSize") );
                        }} );
                        ...
                        put( "cost", new java.util.HashMap<String, Object>() {{
                            put( "min", CexcCore.this.safeNumber(market, "quoteMinSize") );
                            put( "max", CexcCore.this.safeNumber(market, "quoteMaxSize") );
                        }} );
                    }} );
                    put( "created", null );
                    put( "info", market );
    ...
    final Object finalSymbol = symbol;
                ...
                final Object finalLimitPriceMax = limitPriceMax;
                    ...
                    put( "inverse", inverse );
                    put( "taker", CexcCore.this.safeNumber(market, "takerFeeRate") );
                    put( "maker", CexcCore.this.safeNumber(market, "makerFeeRate") );
                    put( "contractSize", CexcCore.this.parseNumber(Precise.stringAbs(multiplier)) );
                    put( "expiry", expiry );
                    put( "expiryDatetime", CexcCore.this.iso8601(expiry) );
                    put( "strike", null );
                    put( "optionType", null );
                    put( "precision", new java.util.HashMap<String, Object>() {{
                        put( "amount", lotSize );
                    ...
                    put( "limits", new java.util.HashMap<String, Object>() {{
                        put( "leverage", new java.util.HashMap<String, Object>() {{
                            put( "min", CexcCore.this.parseNumber("1") );
                            put( "max", CexcCore.this.safeNumber(market, "maxLeverage") );
                        }} );
                        put( "amount", new java.util.HashMap<String, Object>() {{
                    ...
                    put( "created", CexcCore.this.safeInteger(market, "firstOpenDate") );
                    put( "info", market );
                }});
            }
            return result;
    ...
    final Object finalSymbol = symbol;
                ...
                final Object finalInverse = inverse;
                    ...
                    put( "taker", CexcCore.this.safeNumber(market, "makerFeeRate") );
                    put( "maker", CexcCore.this.safeNumber(market, "takerFeeRate") );
                    put( "contractSize", CexcCore.this.safeNumber(market, "unitSize") );
                    put( "expiry", expiry );
                    put( "expiryDatetime", CexcCore.this.iso8601(expiry) );
                    put( "strike", null );
                    put( "optionType", null );
                    put( "precision", new java.util.HashMap<String, Object>() {{
                        put( "amount", CexcCore.this.safeNumber2(market, "lotSize", "baseOrderStep") );
                        put( "price", CexcCore.this.safeNumber(market, "tickSize") );
                    }} );
                    put( "limits", new java.util.HashMap<String, Object>() {{
                        put( "leverage", new java.util.HashMap<String, Object>() {{
                            put( "min", null );
                            put( "max", CexcCore.this.safeInteger(market, "maxLeverage") );
                        }} );
                        put( "amount", new java.util.HashMap<String, Object>() {{
                            put( "min", CexcCore.this.safeNumber(market, "minBaseOrderSize") );
                            put( "max", CexcCore.this.safeNumber(market, "maxBaseOrderSize") );
                        }} );
                        put( "price", new java.util.HashMap<String, Object>() {{
                            put( "min", null );
                            put( "max", CexcCore.this.safeNumber(market, "maxPrice") );
                        }} );
                        put( "cost", new java.util.HashMap<String, Object>() {{
                            put( "min", CexcCore.this.safeNumber(market, "minQuoteOrderSize") );
                            put( "max", CexcCore.this.safeNumber(market, "maxQuoteOrderSize") );
                        }} );
                    }} );
                    put( "created", CexcCore.this.safeInteger(market, "launchTime") );
                    put( "info", market );
                }});
            }
            if (Helpers.isTrue(Helpers.GetValue(this.options, "adjustForTimeDifference")))
    ...
    put( "info", chain );
    put( "id", chainId );
    put( "name", CexcCore.this.safeString(chain, "chainName") );
    put( "code", finalNetworkCode );
    put( "active", null );
    put( "fee", CexcCore.this.safeNumber2(chain, "withdrawalMinFee", "minWithdrawFee") );
    put( "deposit", CexcCore.this.safeBool(chain, "isDepositEnabled") );
    put( "withdraw", CexcCore.this.safeBool(chain, "isWithdrawEnabled") );
    put( "precision", CexcCore.this.parseNumber(CexcCore.this.parsePrecision(CexcCore.this.safeString(chain, "withdrawPrecision"))) );
    put( "limits", new java.util.HashMap<String, Object>() {{
        put( "withdraw", new java.util.HashMap<String, Object>() {{
            put( "min", CexcCore.this.safeNumber2(chain, "withdrawalMinSize", "minWithdrawSize") );
            put( "max", CexcCore.this.safeNumber2(chain, "maxWithdraw", "maxWithdrawSize") );
        }} );
        put( "deposit", new java.util.HashMap<String, Object>() {{
            put( "min", CexcCore.this.safeNumber2(chain, "depositMinSize", "minDepositSize") );
            put( "max", CexcCore.this.safeNumber2(chain, "maxDeposit", "maxDepositSize") );
        }} );
    }} );
}});
            }
        ...
        return this.safeCurrencyStructure(new java.util.HashMap<String, Object>() {{
            put( "id", id );
            put( "name", CexcCore.this.safeString(entry, "fullName") );
            put( "code", code );
    ...
    put( "withdraw", new java.util.HashMap<String, Object>() {{
        put( "fee", CexcCore.this.safeNumber2(chain, "withdrawalMinFee", "withdrawMinFee") );
        put( "percentage", false );
    }} );
    put( "deposit", new java.util.HashMap<String, Object>() {{
        put( "fee", null );
    ...
    public Object parseSpotOrUtaTicker(Object ticker, Object... optionalArgs)
    {
        ...
        return this.safeTicker(new java.util.HashMap<String, Object>() {{
            ...
            put( "datetime", CexcCore.this.iso8601(timestamp) );
            put( "high", CexcCore.this.safeString(ticker, "high") );
            put( "low", CexcCore.this.safeString(ticker, "low") );
            put( "bid", CexcCore.this.safeStringN(ticker, new java.util.ArrayList<Object>(java.util.Arrays.asList("buy", "bestBid", "bestBidPrice"))) );
            put( "bidVolume", CexcCore.this.safeString(ticker, "bestBidSize") );
            put( "ask", CexcCore.this.safeStringN(ticker, new java.util.ArrayList<Object>(java.util.Arrays.asList("sell", "bestAsk", "bestAskPrice"))) );
            put( "askVolume", CexcCore.this.safeString(ticker, "bestAskSize") );
            put( "vwap", null );
            put( "open", CexcCore.this.safeString(ticker, "open") );
            put( "close", finalLast );
            put( "last", finalLast );
            put( "previousClose", null );
            put( "change", CexcCore.this.safeString2(ticker, "changePrice", "priceChange") );
            put( "percentage", finalPercentage );
            put( "average", CexcCore.this.safeString(ticker, "averagePrice") );
            put( "baseVolume", baseVolume );
            put( "quoteVolume", quoteVolume );
            put( "markPrice", CexcCore.this.safeString2(ticker, "markPrice", "value") );
            put( "indexPrice", CexcCore.this.safeString(ticker, "indexPrice") );
            put( "info", ticker );
        }}, market);
    }
    ...
    public Object parseContractTicker(Object ticker, Object... optionalArgs)
    {
        ...
        return this.safeTicker(new java.util.HashMap<String, Object>() {{
            ...
            put( "timestamp", timestamp );
            put( "datetime", CexcCore.this.iso8601(timestamp) );
            put( "high", CexcCore.this.safeString(ticker, "highPrice") );
            put( "low", CexcCore.this.safeString(ticker, "lowPrice") );
            put( "bid", CexcCore.this.safeString(ticker, "bestBidPrice") );
            put( "bidVolume", CexcCore.this.safeString(ticker, "bestBidSize") );
            put( "ask", CexcCore.this.safeString(ticker, "bestAskPrice") );
            put( "askVolume", CexcCore.this.safeString(ticker, "bestAskSize") );
            put( "vwap", null );
            put( "open", null );
            put( "close", last );
            put( "last", last );
            put( "previousClose", null );
            put( "change", CexcCore.this.safeString(ticker, "priceChg") );
            put( "percentage", CexcCore.this.safeString(ticker, "priceChgPct") );
            put( "average", null );
            put( "baseVolume", CexcCore.this.safeString(ticker, "volumeOf24h") );
            put( "quoteVolume", CexcCore.this.safeString(ticker, "turnoverOf24h") );
            put( "markPrice", CexcCore.this.safeString2(ticker, "markPrice", "value") );
            put( "indexPrice", CexcCore.this.safeString(ticker, "indexPrice") );
            put( "info", ticker );
        }}, market);
    ...
    public java.util.concurrent.CompletableFuture<Object> fetchUTAOHLCV(Object symbol, Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            Object request = new java.util.HashMap<String, Object>() {{
                put( "symbol", Helpers.GetValue(market, "id") );
                put( "interval", CexcCore.this.safeString(CexcCore.this.timeframes, timeframe, timeframe) );
            }};
    ...
    public java.util.concurrent.CompletableFuture<Object> fetchSpotOHLCV(Object symbol, Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            Object request = new java.util.HashMap<String, Object>() {{
                put( "symbol", Helpers.GetValue(market, "id") );
                put( "type", CexcCore.this.safeString(CexcCore.this.timeframes, timeframe, timeframe) );
            }};
            Object duration = Helpers.multiply(this.parseTimeframe(timeframe), 1000);
            Object endAt = this.milliseconds(); // required param
            Object denominator = 1000;
    ...
    public java.util.concurrent.CompletableFuture<Object> fetchContractDepositAddress(Object code, Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            return new java.util.HashMap<String, Object>() {{
                put( "info", response );
                put( "currency", finalCurrencyId );
                put( "network", CexcCore.this.safeString(data, "chain") );
                put( "address", address );
                put( "tag", CexcCore.this.safeString(data, "memo") );
            }};
        });
    ...
    public Object parseDepositAddress(Object depositAddress, Object... optionalArgs)
    {
        ...
        return new java.util.HashMap<String, Object>() {{
            ...
            put( "network", CexcCore.this.networkIdToCode(chainId, finalCode) );
            put( "address", finalAddress );
            put( "tag", CexcCore.this.safeString(depositAddress, "memo") );
        }};
    }
    ...
    public Object parseContractOrder(Object order, Object... optionalArgs)
    {
        ...
        return this.safeOrder(new java.util.HashMap<String, Object>() {{
            ...
            put( "amount", amount );
            put( "price", price );
            put( "triggerPrice", CexcCore.this.safeNumber(order, "stopPrice") );
            put( "cost", cost );
            put( "filled", filled );
            put( "remaining", null );
            put( "timestamp", timestamp );
    ...
    public Object parseSpotOrder(Object order, Object... optionalArgs)
    {
        ...
        return this.safeOrder(new java.util.HashMap<String, Object>() {{
            put( "info", order );
            put( "id", CexcCore.this.safeStringN(order, new java.util.ArrayList<Object>(java.util.Arrays.asList("id", "orderId", "newOrderId", "cancelledOrderId"))) );
            put( "clientOrderId", CexcCore.this.safeString(order, "clientOid") );
            put( "symbol", CexcCore.this.safeSymbol(marketId, market, "-") );
            put( "type", CexcCore.this.safeString(order, "type") );
            put( "timeInForce", CexcCore.this.safeString(order, "timeInForce") );
            put( "postOnly", CexcCore.this.safeBool(order, "postOnly") );
            put( "side", CexcCore.this.safeString(order, "side") );
            put( "amount", CexcCore.this.safeString(order, "size") );
            put( "price", CexcCore.this.safeString(order, "price") );
            put( "triggerPrice", CexcCore.this.safeNumber(order, "stopPrice") );
            put( "cost", CexcCore.this.safeString(order, "dealFunds") );
            put( "filled", CexcCore.this.safeString(order, "dealSize") );
            put( "remaining", null );
            put( "timestamp", timestamp );
            put( "datetime", CexcCore.this.iso8601(timestamp) );
            put( "fee", new java.util.HashMap<String, Object>() {{
                put( "currency", CexcCore.this.safeCurrencyCode(feeCurrencyId) );
                put( "cost", CexcCore.this.safeNumber(order, "fee") );
            }} );
            put( "status", finalStatus );
            put( "lastTradeTimestamp", null );
            put( "average", CexcCore.this.safeString(order, "avgDealPrice") );
            put( "trades", null );
        }}, market);
    }
    ...
    public Object parseUtaOrder(Object order, Object... optionalArgs)
    {
        ...
        Object fee = new java.util.HashMap<String, Object>() {{
            put( "currency", CexcCore.this.safeCurrencyCode(CexcCore.this.safeString(order, "feeCurrency")) );
            put( "cost", CexcCore.this.safeString(order, "fee") );
        }};
        final Object finalAmount = amount;
        final Object finalCost = cost;
        final Object finalFilled = filled;
        return this.safeOrder(new java.util.HashMap<String, Object>() {{
            put( "id", CexcCore.this.safeString(order, "orderId") );
            put( "clientOrderId", CexcCore.this.safeString(order, "clientOid") );
            put( "symbol", symbol );
            put( "type", CexcCore.this.safeStringLower(order, "orderType") );
            put( "timeInForce", CexcCore.this.parseOrderTimeInForce(rawTimeInForce) );
            put( "postOnly", CexcCore.this.safeBool(order, "postOnly") );
            put( "reduceOnly", CexcCore.this.safeBool(order, "reduceOnly") );
            put( "side", CexcCore.this.safeStringLower(order, "side") );
            put( "amount", finalAmount );
            put( "price", CexcCore.this.safeString(order, "price") );
            put( "triggerPrice", CexcCore.this.safeString2(order, "stopPrice", "triggerPrice") );
            put( "cost", finalCost );
            ...
            put( "datetime", CexcCore.this.iso8601(timestamp) );
            put( "fee", fee );
            put( "status", CexcCore.this.parseOrderStatus(rawStatus) );
            put( "lastTradeTimestamp", null );
            put( "lastUpdateTimestamp", lastUpdateTimestamp );
            put( "average", average );
            put( "trades", null );
            put( "stopLossPrice", CexcCore.this.safeString(order, "slTriggerPrice") );
            put( "takeProfitPrice", CexcCore.this.safeString(order, "tpTriggerPrice") );
            put( "info", order );
        }}, market);
    }
    ...
    public Object parseSpotOrUtaTrade(Object trade, Object... optionalArgs)
    {
        ...
        if (Helpers.isTrue(!Helpers.isEqual(feeCostString, null)))
        {
            ...
            fee = new java.util.HashMap<String, Object>() {{
                ...
                put( "rate", CexcCore.this.safeString(trade, "feeRate") );
            }};
        }
        ...
        return this.safeTrade(new java.util.HashMap<String, Object>() {{
            ...
            put( "datetime", CexcCore.this.iso8601(finalTimestamp) );
            put( "symbol", Helpers.GetValue(finalMarket, "symbol") );
            put( "type", finalType );
    ...
    public Object parseMyUtaTrade(Object trade, Object... optionalArgs)
    {
        ...
        Object fee = new java.util.HashMap<String, Object>() {{
            put( "cost", CexcCore.this.safeString(trade, "fee") );
            put( "currency", CexcCore.this.safeCurrencyCode(CexcCore.this.safeString(trade, "feeCurrency")) );
        }};
        final Object finalMarket = market;
        return this.safeTrade(new java.util.HashMap<String, Object>() {{
            put( "info", trade );
            put( "id", CexcCore.this.safeString(trade, "tradeId") );
            put( "order", CexcCore.this.safeString(trade, "orderId") );
            put( "timestamp", timestamp );
            put( "datetime", CexcCore.this.iso8601(timestamp) );
            put( "symbol", Helpers.GetValue(finalMarket, "symbol") );
            put( "type", CexcCore.this.safeStringLower(trade, "orderType") );
            put( "takerOrMaker", CexcCore.this.safeStringLower(trade, "liquidityRole") );
            put( "side", CexcCore.this.safeStringLower(trade, "side") );
            put( "price", CexcCore.this.safeString(trade, "price") );
            put( "amount", CexcCore.this.safeString(trade, "size") );
            put( "cost", CexcCore.this.safeString(trade, "value") );
            put( "fee", fee );
        }}, market);
    }
    ...
    public java.util.concurrent.CompletableFuture<Object> fetchTradingFee(Object symbol, Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            return new java.util.HashMap<String, Object>() {{
                put( "info", finalResponse );
                put( "symbol", CexcCore.this.safeSymbol(marketId, market) );
                put( "maker", CexcCore.this.safeNumber(finalEntry, "makerFeeRate") );
                put( "taker", CexcCore.this.safeNumber(finalEntry, "takerFeeRate") );
                put( "percentage", true );
                put( "tierBased", true );
            }};
        });
    ...
    public Object parseTransaction(Object transaction, Object... optionalArgs)
    {
        ...
        if (Helpers.isTrue(!Helpers.isEqual(feeCost, null)))
        {
            ...
            fee = new java.util.HashMap<String, Object>() {{
                put( "cost", CexcCore.this.parseNumber(finalFeeCost) );
                put( "rate", CexcCore.this.parseNumber(finalRate) );
                put( "currency", code );
            }};
        }
        ...
        return new java.util.HashMap<String, Object>() {{
            ...
            put( "id", CexcCore.this.safeString2(transaction, "id", "withdrawalId") );
            put( "timestamp", finalTimestamp );
            put( "datetime", CexcCore.this.iso8601(finalTimestamp) );
            put( "network", CexcCore.this.networkIdToCode(chainId, code) );
            put( "address", finalAddress );
            ...
            put( "tagFrom", null );
            put( "currency", code );
            put( "amount", CexcCore.this.parseNumber(finalAmount) );
            put( "txid", finalTxid );
            put( "type", finalType );
            put( "status", CexcCore.this.parseTransactionStatus(rawStatus) );
            put( "comment", CexcCore.this.safeString(transaction, "remark") );
            put( "internal", intern );
            put( "fee", finalFee );
    ...
    public Object parseTransfer(Object transfer, Object... optionalArgs)
    {
        ...
        return new java.util.HashMap<String, Object>() {{
            put( "id", CexcCore.this.safeStringN(transfer, new java.util.ArrayList<Object>(java.util.Arrays.asList("id", "applyId", "orderId"))) );
            put( "currency", CexcCore.this.safeCurrencyCode(currencyId, currency) );
            put( "timestamp", timestamp );
            put( "datetime", CexcCore.this.iso8601(timestamp) );
            put( "amount", CexcCore.this.safeNumber(transfer, "amount") );
            put( "fromAccount", accountFrom );
            put( "toAccount", accountTo );
            put( "status", CexcCore.this.parseTransferStatus(rawStatus) );
            put( "info", transfer );
        }};
    }
    ...
    public Object parseLedgerEntry(Object item, Object... optionalArgs)
    {
        ...
        return this.safeLedgerEntry(new java.util.HashMap<String, Object>() {{
            put( "info", item );
            put( "id", id );
            put( "direction", CexcCore.this.parseLedgerDirection(direction) );
            put( "account", finalAccount );
            put( "referenceId", finalReferenceId );
            put( "referenceAccount", finalAccount );
            put( "type", type );
            put( "currency", code );
            put( "amount", CexcCore.this.parseNumber(Precise.stringAbs(amount)) );
            put( "timestamp", finalTimestamp );
            put( "datetime", datetime );
            put( "before", null );
            put( "after", balanceAfter );
            put( "status", CexcCore.this.parseLedgerStatus(status) );
            put( "fee", finalFee );
        }}, currency);
    }
    ...
    public Object parseBorrowRate(Object info, Object... optionalArgs)
    {
        ...
        return new java.util.HashMap<String, Object>() {{
            put( "currency", CexcCore.this.safeCurrencyCode(currencyId, currency) );
            put( "rate", CexcCore.this.safeNumberN(info, new java.util.ArrayList<Object>(java.util.Arrays.asList("dailyIntRate", "dayRatio", "currentRateDaily"))) );
            put( "period", 86400000 );
            put( "timestamp", finalTimestamp );
            put( "datetime", CexcCore.this.iso8601(finalTimestamp) );
            put( "info", info );
    ...
    public Object parseBorrowInterest(Object info, Object... optionalArgs)
    {
        ...
        return new java.util.HashMap<String, Object>() {{
            put( "info", info );
            put( "symbol", symbol );
            put( "currency", CexcCore.this.safeCurrencyCode(finalCurrencyId) );
            put( "interest", finalInterest );
            put( "interestRate", CexcCore.this.safeNumber(info, "dailyIntRate") );
    ...
    public java.util.concurrent.CompletableFuture<Object> borrowCrossMargin(Object code, Object amount, Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            Object request = new java.util.HashMap<String, Object>() {{
                put( "currency", Helpers.GetValue(currency, "id") );
                put( "size", CexcCore.this.currencyToPrecision(code, amount) );
                put( "timeInForce", "FOK" );
            }};
    ...
    public Object parseMarginLoan(Object info, Object... optionalArgs)
    {
        ...
        Object currencyId = this.safeString(info, "currency");
        return new java.util.HashMap<String, Object>() {{
            put( "id", CexcCore.this.safeString(info, "orderNo") );
            put( "currency", CexcCore.this.safeCurrencyCode(currencyId, currency) );
            put( "amount", CexcCore.this.safeNumber(info, "actualSize") );
            put( "symbol", null );
            put( "timestamp", timestamp );
            put( "datetime", CexcCore.this.iso8601(timestamp) );
            put( "info", info );
    ...
    public java.util.concurrent.CompletableFuture<Object> setLeverage(Object leverage, Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            Object request = new java.util.HashMap<String, Object>() {{
                put( "leverage", CexcCore.this.numberToString(leverage) );
            }};
            Object marginMode = null;
    ...
    public Object parseFundingRate(Object data, Object... optionalArgs)
    {
        ...
        return new java.util.HashMap<String, Object>() {{
            put( "info", data );
            put( "symbol", CexcCore.this.safeSymbol(marketId, market, null, "contract") );
            put( "markPrice", null );
            put( "indexPrice", null );
            put( "interestRate", CexcCore.this.safeNumber(data, "dailyInterestRate") );
            put( "estimatedSettlePrice", null );
            put( "timestamp", null );
            put( "datetime", null );
            put( "fundingRate", CexcCore.this.safeNumber2(data, "nextFundingRate", "value") );
            put( "fundingTimestamp", fundingTimestamp );
            put( "fundingDatetime", CexcCore.this.iso8601(fundingTimestamp) );
            put( "nextFundingRate", null );
            put( "nextFundingTimestamp", nextFundingTimestamp );
            put( "nextFundingDatetime", CexcCore.this.iso8601(nextFundingTimestamp) );
            put( "previousFundingRate", null );
            put( "previousFundingTimestamp", previousFundingTimestamp );
            put( "previousFundingDatetime", CexcCore.this.iso8601(previousFundingTimestamp) );
            put( "interval", CexcCore.this.parseFundingInterval(granularity) );
        }};
    }
    ...
    public Object parseFundingRateHistory(Object info, Object... optionalArgs)
    {
        ...
        return new java.util.HashMap<String, Object>() {{
            put( "info", info );
            put( "symbol", CexcCore.this.safeSymbol(marketId, market) );
            put( "fundingRate", CexcCore.this.safeNumber(info, "fundingRate") );
            put( "timestamp", timestamp );
            put( "datetime", CexcCore.this.iso8601(timestamp) );
        }};
    }
    ...
    final Object finalMarket = market;
                    ...
                    put( "info", listItem );
                    put( "symbol", CexcCore.this.safeSymbol(marketId, finalMarket) );
                    put( "code", CexcCore.this.safeCurrencyCode(CexcCore.this.safeString(listItem, "settleCurrency")) );
                    put( "timestamp", timestamp );
                    put( "datetime", CexcCore.this.iso8601(timestamp) );
                    put( "id", CexcCore.this.safeNumber(listItem, "id") );
                    put( "amount", CexcCore.this.safeNumber2(listItem, "funding", "fundingFee") );
                    put( "fundingRate", CexcCore.this.safeNumber(listItem, "fundingRate") );
                    put( "markPrice", CexcCore.this.safeNumber(listItem, "markPrice") );
                    put( "positionQty", CexcCore.this.safeNumber2(listItem, "positionQty", "size") );
                    put( "positionCost", CexcCore.this.safeNumber2(listItem, "positionCost", "positionValue") );
                }});
            }
            return fees;
        });
    ...
    public Object parsePosition(Object position, Object... optionalArgs)
    {
        ...
        return this.safePosition(new java.util.HashMap<String, Object>() {{
            put( "info", position );
            put( "id", CexcCore.this.safeStringN(position, new java.util.ArrayList<Object>(java.util.Arrays.asList("id", "positionId", "closeId"))) );
            put( "symbol", CexcCore.this.safeString(finalMarket, "symbol") );
            put( "timestamp", finalTimestamp );
            put( "datetime", CexcCore.this.iso8601(finalTimestamp) );
            put( "lastUpdateTimestamp", finalLastUpdateTimestamp );
            put( "initialMargin", CexcCore.this.parseNumber(initialMargin) );
            put( "initialMarginPercentage", CexcCore.this.parseNumber(initialMarginPercentage) );
            put( "maintenanceMargin", CexcCore.this.safeNumber2(position, "posMaint", "maintenanceMargin") );
            put( "maintenanceMarginPercentage", CexcCore.this.safeNumber2(position, "maintMarginReq", "mmr") );
            put( "entryPrice", CexcCore.this.safeNumberN(position, new java.util.ArrayList<Object>(java.util.Arrays.asList("avgEntryPrice", "openPrice", "entryPrice"))) );
            put( "notional", CexcCore.this.parseNumber(notional) );
            put( "leverage", CexcCore.this.safeNumber2(position, "realLeverage", "leverage") );
            put( "unrealizedPnl", CexcCore.this.parseNumber(unrealisedPnl) );
            put( "contracts", CexcCore.this.parseNumber(Precise.stringAbs(finalSize)) );
            put( "contractSize", CexcCore.this.safeValue(finalMarket, "contractSize") );
            put( "realizedPnl", CexcCore.this.safeNumberN(position, new java.util.ArrayList<Object>(java.util.Arrays.asList("realisedPnl", "pnl", "realizedPnL"))) );
            put( "marginRatio", null );
            put( "liquidationPrice", CexcCore.this.safeNumber(position, "liquidationPrice") );
            put( "markPrice", CexcCore.this.safeNumber(position, "markPrice") );
            put( "lastPrice", CexcCore.this.safeNumber(position, "closePrice") );
            put( "collateral", CexcCore.this.safeNumber(position, "maintMargin") );
            put( "marginMode", finalMarginMode );
            put( "side", finalSide );
            put( "percentage", null );
    ...
    final Object finalMarket = market;
                final Object finalI = i;
                    ...
                    put( "symbol", CexcCore.this.safeString(finalMarket, "id") );
                    put( "clientOid", CexcCore.this.safeString(clientOrderIds, finalI) );
                }});
            }
    ...
    public java.util.concurrent.CompletableFuture<Object> addMargin(Object symbol, Object amount, Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            Object request = new java.util.HashMap<String, Object>() {{
                put( "symbol", Helpers.GetValue(market, "id") );
                put( "margin", CexcCore.this.amountToPrecision(symbol, amount) );
                put( "bizNo", uuid );
            }};
            ...
            return this.extend(this.parseMarginModification(data, market), new java.util.HashMap<String, Object>() {{
                put( "amount", CexcCore.this.amountToPrecision(symbol, amount) );
                put( "direction", "in" );
            }});
        });
    ...
    public java.util.concurrent.CompletableFuture<Object> reduceMargin(Object symbol, Object amount, Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            return new java.util.HashMap<String, Object>() {{
                ...
                put( "amount", CexcCore.this.parseNumber(amountString) );
                put( "total", null );
                put( "code", CexcCore.this.safeCurrencyCode(currencyId) );
    ...
    public Object parseMarginMode(Object marginMode, Object... optionalArgs)
    {
        ...
        return new java.util.HashMap<String, Object>() {{
            put( "info", marginMode );
            put( "symbol", CexcCore.this.safeString(market, "symbol") );
...
final Object finalMarket = market;
                ...
                put( "tier", CexcCore.this.safeNumber2(tier, "level", "tier") );
                put( "symbol", Helpers.GetValue(finalMarket, "symbol") );
                put( "currency", Helpers.GetValue(finalMarket, "base") );
                put( "minNotional", CexcCore.this.safeNumber2(tier, "minRiskLimit", "minSize") );
                put( "maxNotional", CexcCore.this.safeNumber2(tier, "maxRiskLimit", "maxSize") );
                put( "maintenanceMarginRate", CexcCore.this.safeNumber2(tier, "maintainMargin", "maintainMarginRate") );
                put( "maxLeverage", CexcCore.this.safeNumber(tier, "maxLeverage") );
                put( "info", tier );
            }});
        }
        return tiers;
    ...
    public Object parseOpenInterest(Object interest, Object... optionalArgs)
    {
        ...
        return this.safeOpenInterest(new java.util.HashMap<String, Object>() {{
            put( "symbol", CexcCore.this.safeSymbol(marketId) );
            put( "openInterestAmount", CexcCore.this.safeNumber(interest, "openInterest") );
    ...
    public Object sign(Object path, Object... optionalArgs)
    {
        ...
        if (Helpers.isTrue(Helpers.isTrue(Helpers.isTrue(Helpers.isTrue(Helpers.isTrue(isPrivate) || Helpers.isTrue(isFuturePrivate)) || Helpers.isTrue(isBroker)) || Helpers.isTrue(isEarn)) || Helpers.isTrue(isUtaPrivate)))
        {
            ...
            headers = this.extend(new java.util.HashMap<String, Object>() {{
                ...
                put( "KC-API-KEY", CexcCore.this.apiKey );
    ...
    public Object parseADLRank(Object info, Object... optionalArgs)
    {
        ...
        return new java.util.HashMap<String, Object>() {{
            ...
            put( "rank", null );
            put( "rating", null );
            put( "percentage", CexcCore.this.parseNumber(Precise.stringMul(percentage, "100")) );
            put( "timestamp", timestamp );
            put( "datetime", CexcCore.this.iso8601(timestamp) );
        }};
    }
