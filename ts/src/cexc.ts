...
export default class cexc extends Exchange {
    ...
    async withdraw (code: string, amount: number, address: string, tag: Str = undefined, params = {}): Promise<Transaction> {
        ...
        // is a required string); parseFloat would serialize it as a JSON number and the broker
        // rejects it with a 400 decode error. currencyToPrecision already returns the precise string.
