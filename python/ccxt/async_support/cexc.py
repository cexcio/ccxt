...
class cexc(Exchange, ImplicitAPI):
    ...
    async def load_migration_status(self, force: bool = False):
        ...
        https://exchange-broker.cexc.io/docs-new/rest/account-info/account-funding/get-account-type-spot
    ...
    async def fetch_accounts(self, params={}) -> List[Account]:
        ...
        https://exchange-broker.cexc.io/docs-new/rest/account-info/account-funding/get-account-list-spot
    ...
    async def fetch_transaction_fee(self, code: str, params={}):
        ...
        *DEPRECATED* please use fetchDepositWithdrawFee instead
        ...
        https://exchange-broker.cexc.io/docs-new/rest/account-info/withdrawals/get-withdrawal-quotas
    ...
    async def fetch_mark_prices(self, symbols: Strings = None, params={}) -> Tickers:
        ...
        https://exchange-broker.cexc.io/docs-new/rest/margin-trading/market-data/get-mark-price-list
 ...
 @ignore
    ...
    async def create_deposit_address(self, code: str, params={}) -> DepositAddress:
        ...
        https://exchange-broker.cexc.io/docs-new/rest/account-info/deposit/add-deposit-address-v3
    ...
    async def fetch_deposit_address(self, code: str, params={}) -> DepositAddress:
        ...
        if accountType == 'contract':
            ...
            return await super(cexc, self).fetch_deposit_address(code, self.extend(params, {'uta': True}))
        currency = self.currency(code)
        request = {
            'currency': currency['id'],
    ...
    async def fetch_contract_deposit_address(self, code: str, params={}) -> DepositAddress:
        ...
        https://exchange-broker.cexc.io/docs/rest/funding/deposit/get-deposit-address
 ...
 Check fetchMySpotTrades() and fetchMyContractTrades() for more details on the extra parameters that can be used in params
    ...
    async def withdraw(self, code: str, amount: float, address: str, tag: Str = None, params={}) -> Transaction:
        ...
        https://exchange-broker.cexc.io/docs-new/rest/account-info/withdrawals/withdraw-v3
 ...
 Check transferClassic() and transferUta() for more details on params
    ...
    async def fetch_borrow_rate_histories(self, codes: Strings = None, since: Int = None, limit: Int = None, params={}):
        ...
        https://exchange-broker.cexc.io/docs-new/rest/margin-trading/debit/get-interest-history
    ...
    async def fetch_cross_borrow_rate(self, code: str, params={}) -> CrossBorrowRate:
        ...
        https://exchange-broker.cexc.io/docs-new/rest/ua/get-borrowing-rates-and-limits
    ...
    async def borrow_cross_margin(self, code: str, amount: float, params={}) -> MarginLoan:
        ...
        https://exchange-broker.cexc.io/docs-new/rest/margin-trading/debit/borrow
    ...
    async def repay_cross_margin(self, code: str, amount: float, params={}) -> MarginLoan:
        ...
        https://exchange-broker.cexc.io/docs-new/rest/margin-trading/debit/repay
    ...
    async def fetch_leverage(self, symbol: str, params={}) -> Leverage:
        ...
        https://exchange-broker.cexc.io/docs-new/rest/futures-trading/positions/get-cross-margin-leverage
    ...
    async def fetch_funding_history(self, symbol: Str = None, since: Int = None, limit: Int = None, params={}):
        ...
        https://exchange-broker.cexc.io/docs-new/rest/futures-trading/funding-fees/get-private-funding-history
    ...
    async def add_margin(self, symbol: str, amount: float, params={}) -> MarginModification:
        ...
        https://exchange-broker.cexc.io/docs-new/rest/futures-trading/positions/add-isolated-margin
    ...
    async def reduce_margin(self, symbol: str, amount: float, params={}) -> MarginModification:
        ...
        https://exchange-broker.cexc.io/docs-new/rest/futures-trading/positions/remove-isolated-margin
    ...
    async def fetch_margin_mode(self, symbol: str, params={}) -> MarginMode:
        ...
        https://exchange-broker.cexc.io/docs-new/rest/futures-trading/positions/get-margin-mode
    ...
    async def set_margin_mode(self, marginMode: str, symbol: Str = None, params={}):
        ...
        https://exchange-broker.cexc.io/docs-new/rest/futures-trading/positions/switch-margin-mode
    ...
    async def set_position_mode(self, hedged: bool, symbol: Str = None, params={}):
        ...
        https://exchange-broker.cexc.io/docs-new/rest/futures-trading/positions/switch-position-mode
    ...
    async def fetch_position_mode(self, symbol: Str = None, params={}) -> PositionModeInfo:
        ...
        https://exchange-broker.cexc.io/docs-new/rest/futures-trading/positions/get-position-mode
    ...
    async def fetch_market_leverage_tiers(self, symbol: str, params={}) -> List[LeverageTier]:
        ...
        https://exchange-broker.cexc.io/docs-new/rest/futures-trading/positions/get-isolated-margin-risk-limit
 ...
 @ignore
    ...
    async def fetch_leverage_tiers(self, symbols: Strings = None, params={}) -> LeverageTiers:
        ...
        https://exchange-broker.cexc.io/docs-new/rest/ua/get-position-tiers
    ...
    async def fetch_open_interests(self, symbols: Strings = None, params={}):
        ...
        https://exchange-broker.cexc.io/docs-new/rest/ua/get-futures-open-interset
    ...
    async def is_uta_enabled(self, params={}) -> bool:
        ...
        https://exchange-broker.cexc.io/docs-new/rest/ua/get-account-mode
