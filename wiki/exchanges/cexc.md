...
- https://exchange-broker.cexc.io/docs-new/rest/spot-trading/market-data/get-server-time
- https://exchange-broker.cexc.io/docs-new/rest/futures-trading/market-data/get-server-time
...
- https://exchange-broker.cexc.io/docs-new/rest/spot-trading/market-data/get-service-status
- https://exchange-broker.cexc.io/docs-new/rest/futures-trading/market-data/get-service-status
- https://exchange-broker.cexc.io/docs-new/rest/ua/get-service-status
...
- https://exchange-broker.cexc.io/docs-new/rest/spot-trading/market-data/get-all-symbols
- https://exchange-broker.cexc.io/docs-new/rest/ua/get-symbol
- https://exchange-broker.cexc.io/docs-new/rest/futures-trading/market-data/get-all-symbols
...
**See**: https://exchange-broker.cexc.io/docs-new/rest/account-info/account-funding/get-account-type-spot  
...
```javascript
cexc.loadMigrationStatus (force)
```
...
- https://exchange-broker.cexc.io/docs-new/rest/spot-trading/market-data/get-all-currencies
- https://exchange-broker.cexc.io/docs-new/rest/ua/get-currencies
...
**See**: https://exchange-broker.cexc.io/docs-new/rest/account-info/account-funding/get-account-list-spot  
...
**See**: https://exchange-broker.cexc.io/docs-new/rest/account-info/withdrawals/get-withdrawal-quotas  
...
- https://exchange-broker.cexc.io/docs-new/rest/spot-trading/market-data/get-all-tickers
- https://exchange-broker.cexc.io/docs-new/rest/futures-trading/market-data/get-all-tickers
- https://exchange-broker.cexc.io/docs-new/rest/ua/get-ticker
...
**See**: https://exchange-broker.cexc.io/docs-new/rest/margin-trading/market-data/get-mark-price-list  
...
- https://exchange-broker.cexc.io/docs-new/rest/spot-trading/market-data/get-24hr-stats
- https://exchange-broker.cexc.io/docs-new/rest/futures-trading/market-data/get-ticker
- https://exchange-broker.cexc.io/docs-new/rest/ua/get-ticker
...
- https://exchange-broker.cexc.io/docs-new/rest/margin-trading/market-data/get-mark-price-detail
- https://exchange-broker.cexc.io/docs-new/rest/futures-trading/market-data/get-mark-price
...
- https://exchange-broker.cexc.io/docs-new/rest/spot-trading/market-data/get-klines
- https://exchange-broker.cexc.io/docs-new/rest/futures-trading/market-data/get-klines
- https://exchange-broker.cexc.io/docs-new/rest/ua/get-klines
...
**See**: https://exchange-broker.cexc.io/docs-new/rest/account-info/deposit/add-deposit-address-v3  
...
- https://exchange-broker.cexc.io/docs-new/rest/account-info/deposit/get-deposit-address-v3/en
- https://exchange-broker.cexc.io/docs-new/rest/ua/get-deposit-address
...
**See**: https://exchange-broker.cexc.io/docs/rest/funding/deposit/get-deposit-address  
...
```javascript
cexc.fetchContractDepositAddress (code, params?)
```
...
- https://exchange-broker.cexc.io/docs-new/rest/spot-trading/market-data/get-part-orderbook
- https://exchange-broker.cexc.io/docs-new/rest/spot-trading/market-data/get-full-orderbook
- https://exchange-broker.cexc.io/docs-new/rest/futures-trading/market-data/get-part-orderbook
- https://exchange-broker.cexc.io/docs-new/rest/ua/get-orderbook
...
- https://exchange-broker.cexc.io/docs-new/rest/spot-trading/orders/add-order
- https://exchange-broker.cexc.io/docs-new/rest/spot-trading/orders/add-order-sync
- https://exchange-broker.cexc.io/docs-new/rest/spot-trading/orders/add-order-test
- https://exchange-broker.cexc.io/docs-new/rest/spot-trading/orders/add-stop-order
- https://exchange-broker.cexc.io/docs-new/rest/margin-trading/orders/add-order
- https://exchange-broker.cexc.io/docs-new/rest/margin-trading/orders/add-order-test
- https://exchange-broker.cexc.io/docs-new/rest/margin-trading/orders/add-stop-order
- https://exchange-broker.cexc.io/docs-new/rest/futures-trading/orders/add-order
- https://exchange-broker.cexc.io/docs-new/rest/futures-trading/orders/add-order-test
- https://exchange-broker.cexc.io/docs-new/rest/futures-trading/orders/add-take-profit-and-stop-loss-order
- https://exchange-broker.cexc.io/docs-new/rest/ua/place-order
...
```javascript
cexc.createSpotOrder (symbol, type, side, amount, price?, params?)
```
...
```javascript
cexc.createContractOrder (symbol, type, side, amount, price?, params?)
```
...
**See**: https://exchange-broker.cexc.io/docs-new/rest/ua/place-order  
...
```javascript
cexc.createUtaOrder (symbol, type, side, amount, price?, params?)
```
...
- https://exchange-broker.cexc.io/docs-new/rest/spot-trading/orders/batch-add-orders
- https://exchange-broker.cexc.io/docs-new/rest/spot-trading/orders/batch-add-orders-sync
...
- https://exchange-broker.cexc.io/docs-new/rest/spot-trading/orders/batch-add-orders
- https://exchange-broker.cexc.io/docs-new/rest/spot-trading/orders/batch-add-orders-sync
- https://exchange-broker.cexc.io/docs-new/rest/futures-trading/orders/batch-add-orders
...
```javascript
cexc.createSpotOrders (orders, params?)
```
...
**See**: https://exchange-broker.cexc.io/docs-new/rest/futures-trading/orders/batch-add-orders  
...
```javascript
cexc.createContractOrders (orders, params?)
```
...
- https://exchange-broker.cexc.io/docs-new/rest/spot-trading/orders/cancel-order-by-orderld
- https://exchange-broker.cexc.io/docs-new/rest/spot-trading/orders/cancel-order-by-orderld-sync
- https://exchange-broker.cexc.io/docs-new/rest/spot-trading/orders/cancel-order-by-clientoid
- https://exchange-broker.cexc.io/docs-new/rest/spot-trading/orders/cancel-order-by-clientoid-sync
- https://exchange-broker.cexc.io/docs-new/rest/spot-trading/orders/cancel-stop-order-by-clientoid
- https://exchange-broker.cexc.io/docs-new/rest/spot-trading/orders/cancel-stop-order-by-orderld
- https://exchange-broker.cexc.io/docs-new/rest/margin-trading/orders/cancel-order-by-orderld
- https://exchange-broker.cexc.io/docs-new/rest/margin-trading/orders/cancel-order-by-clientoid
- https://exchange-broker.cexc.io/docs-new/rest/margin-trading/orders/cancel-stop-order-by-orderld
- https://exchange-broker.cexc.io/docs-new/rest/margin-trading/orders/cancel-stop-order-by-clientoid
- https://exchange-broker.cexc.io/docs-new/rest/futures-trading/orders/cancel-order-by-orderld
- https://exchange-broker.cexc.io/docs-new/rest/futures-trading/orders/cancel-order-by-clientoid
- https://exchange-broker.cexc.io/docs-new/rest/ua/cancel-order
...
```javascript
cexc.cancelSpotOrder (id, symbol, params?)
```
...
```javascript
cexc.cancelContractOrder (id, symbol, params?)
```
...
**See**: https://exchange-broker.cexc.io/docs-new/rest/ua/cancel-order  
...
```javascript
cexc.cancelUtaOrder (id, symbol, params?)
```
...
- https://exchange-broker.cexc.io/docs-new/rest/spot-trading/orders/cancel-all-orders-by-symbol
- https://exchange-broker.cexc.io/docs-new/rest/spot-trading/orders/cancel-all-orders
- https://exchange-broker.cexc.io/docs-new/rest/spot-trading/orders/batch-cancel-stop-orders
- https://exchange-broker.cexc.io/docs-new/rest/margin-trading/orders/cancel-all-orders-by-symbol
- https://exchange-broker.cexc.io/docs-new/rest/margin-trading/orders/batch-cancel-stop-orders
- https://exchange-broker.cexc.io/docs-new/rest/futures-trading/orders/cancel-all-orders
- https://exchange-broker.cexc.io/docs-new/rest/futures-trading/orders/cancel-all-stop-orders
- https://exchange-broker.cexc.io/docs-new/rest/ua/batch-cancel-order-by-symbol
...
```javascript
cexc.cancelAllSpotOrders (symbol, params?)
```
...
```javascript
cexc.cancelAllContractOrders (symbol, params?)
```
...
**See**: https://exchange-broker.cexc.io/docs-new/rest/ua/batch-cancel-order-by-symbol  
...
```javascript
cexc.cancelAllUtaOrders (symbol, params?)
```
...
- https://exchange-broker.cexc.io/docs-new/rest/spot-trading/orders/get-open-orders
- https://exchange-broker.cexc.io/docs-new/rest/spot-trading/orders/get-closed-orders
- https://exchange-broker.cexc.io/docs-new/rest/spot-trading/orders/get-stop-orders-list
- https://exchange-broker.cexc.io/docs-new/rest/margin-trading/orders/get-open-orders
- https://exchange-broker.cexc.io/docs-new/rest/margin-trading/orders/get-closed-orders
- https://exchange-broker.cexc.io/docs-new/rest/margin-trading/orders/get-stop-order-list
- https://exchange-broker.cexc.io/docs-new/rest/futures-trading/orders/get-order-list
- https://exchange-broker.cexc.io/docs-new/rest/futures-trading/orders/get-stop-order-list
- https://exchange-broker.cexc.io/docs-new/rest/ua/get-open-order-list
- https://exchange-broker.cexc.io/docs-new/rest/ua/get-order-history
...
```javascript
cexc.fetchSpotOrdersByStatus (status, symbol, since?, limit?, params?)
```
...
```javascript
cexc.fetchContractOrdersByStatus (status, symbol, since?, limit?, params?)
```
...
```javascript
cexc.fetchUtaOrdersByStatus (status, symbol, since?, limit?, params?)
```
...
- https://exchange-broker.cexc.io/docs-new/rest/spot-trading/orders/get-order-by-orderld
- https://exchange-broker.cexc.io/docs-new/rest/spot-trading/orders/get-order-by-clientoid
- https://exchange-broker.cexc.io/docs-new/rest/spot-trading/orders/get-stop-order-by-orderld
- https://exchange-broker.cexc.io/docs-new/rest/spot-trading/get-stop-order-by-clientoid
- https://exchange-broker.cexc.io/docs-new/rest/margin-trading/orders/get-order-by-orderld
- https://exchange-broker.cexc.io/docs-new/rest/margin-trading/orders/get-order-by-clientoid
- https://exchange-broker.cexc.io/docs-new/rest/margin-trading/orders/get-stop-order-by-orderld
- https://exchange-broker.cexc.io/docs-new/rest/margin-trading/orders/get-stop-order-by-clientoid
- https://exchange-broker.cexc.io/docs-new/rest/futures-trading/orders/get-order-by-orderld
- https://exchange-broker.cexc.io/docs-new/rest/futures-trading/get-stop-order-by-clientoid
- https://exchange-broker.cexc.io/docs-new/rest/ua/get-order-details
...
```javascript
cexc.fetchSpotOrder (id, symbol, params?)
```
...
```javascript
cexc.fetchContractOrder (id, symbol, params?)
```
...
**See**: https://exchange-broker.cexc.io/docs-new/rest/ua/get-order-details  
...
```javascript
cexc.fetchUtaOrder (id, symbol, params?)
```
...
- https://exchange-broker.cexc.io/docs-new/rest/spot-trading/orders/get-trade-history
- https://exchange-broker.cexc.io/docs-new/rest/futures-trading/orders/get-trade-history
- https://exchange-broker.cexc.io/docs-new/rest/margin-trading/orders/get-trade-history
- https://exchange-broker.cexc.io/docs-new/rest/ua/get-trade-history
...
```javascript
cexc.fetchMySpotTrades (symbol, since?, limit?, params?)
```
...
**See**: https://exchange-broker.cexc.io/docs-new/rest/futures-trading/orders/get-trade-history  
...
```javascript
cexc.fetchMyContractTrades (symbol, since?, limit?, params?)
```
...
**See**: https://exchange-broker.cexc.io/docs-new/rest/ua/get-trade-history  
...
```javascript
cexc.fetchMyUtaTrades (symbol, since?, limit?, params?)
```
...
- https://exchange-broker.cexc.io/docs-new/rest/spot-trading/market-data/get-trade-history
- https://exchange-broker.cexc.io/docs-new/rest/ua/get-trades
- https://exchange-broker.cexc.io/docs-new/rest/futures-trading/market-data/get-trade-history
...
- https://exchange-broker.cexc.io/docs-new/rest/account-info/trade-fee/get-actual-fee-spot-margin
- https://exchange-broker.cexc.io/docs-new/rest/account-info/trade-fee/get-actual-fee-futures
- https://exchange-broker.cexc.io/docs-new/rest/ua/get-actual-fee
...
**See**: https://exchange-broker.cexc.io/docs-new/rest/account-info/withdrawals/withdraw-v3  
...
- https://exchange-broker.cexc.io/docs-new/rest/account-info/deposit/get-deposit-history
- https://exchange-broker.cexc.io/docs-new/abandoned-endpoints/account-funding/get-deposit-history-old
...
```javascript
cexc.fetchContractDeposits (code, since?, limit?, params?)
```
...
- https://exchange-broker.cexc.io/docs-new/rest/account-info/withdrawals/get-withdrawal-history
- https://exchange-broker.cexc.io/docs-new/abandoned-endpoints/account-funding/get-withdrawal-history-old
...
```javascript
cexc.fetchContractWithdrawals (code, since?, limit?, params?)
```
...
- https://exchange-broker.cexc.io/docs-new/rest/account-info/account-funding/get-account-detail-spot
- https://exchange-broker.cexc.io/docs-new/rest/account-info/account-funding/get-account-cross-margin
- https://exchange-broker.cexc.io/docs-new/rest/account-info/account-funding/get-account-isolated-margin
- https://exchange-broker.cexc.io/docs-new/rest/account-info/account-funding/get-account-futures
- https://exchange-broker.cexc.io/docs-new/rest/ua/get-account-currency-assets-uta
- https://exchange-broker.cexc.io/docs-new/rest/ua/get-account-currency-assets-classic
...
**See**: https://exchange-broker.cexc.io/docs-new/rest/account-info/account-funding/get-account-futures  
...
```javascript
cexc.fetchContractBalance (params?)
```
...
- https://exchange-broker.cexc.io/docs-new/rest/account-info/transfer/flex-transfer?lang=en_US&
- https://exchange-broker.cexc.io/docs-new/rest/ua/flex-transfer
...
**See**: https://exchange-broker.cexc.io/docs-new/rest/ua/flex-transfer  
...
```javascript
cexc.transferUta (code, amount, fromAccount, toAccount, params?)
```
...
**See**: https://exchange-broker.cexc.io/docs-new/rest/account-info/transfer/flex-transfer?lang=en_US&  
...
```javascript
cexc.transferClassic (code, amount, fromAccount, toAccount, params?)
```
...
- https://exchange-broker.cexc.io/docs-new/rest/account-info/account-funding/get-account-ledgers-spot-margin
- https://exchange-broker.cexc.io/docs-new/rest/account-info/account-funding/get-account-ledgers-tradehf
- https://exchange-broker.cexc.io/docs-new/rest/account-info/account-funding/get-account-ledgers-marginhf
- https://exchange-broker.cexc.io/docs-new/rest/account-info/account-funding/get-account-ledgers-futures
- https://exchange-broker.cexc.io/docs-new/rest/ua/get-account-ledger
...
**See**: https://exchange-broker.cexc.io/docs-new/rest/margin-trading/debit/get-interest-history  
...
**See**: https://exchange-broker.cexc.io/docs-new/rest/ua/get-borrowing-rates-and-limits  
...
```javascript
cexc.fetchCrossBorrowRate (code, params?)
```
...
**See**: https://exchange-broker.cexc.io/docs-new/rest/margin-trading/debit/borrow  
...
**See**: https://exchange-broker.cexc.io/docs-new/rest/margin-trading/debit/repay  
...
**See**: https://exchange-broker.cexc.io/docs-new/rest/spot-trading/market-data/get-all-currencies  
...
**See**: https://exchange-broker.cexc.io/docs-new/rest/futures-trading/positions/get-cross-margin-leverage  
...
```javascript
cexc.fetchLeverage (symbol, params?)
```
...
- https://exchange-broker.cexc.io/docs-new/rest/margin-trading/debit/modify-leverage // margin
- https://exchange-broker.cexc.io/docs-new/rest/futures-trading/positions/modify-cross-margin-leverage // contract
- https://exchange-broker.cexc.io/docs-new/rest/ua/modify-cross-margin-leverage-uta // margin uta
- https://exchange-broker.cexc.io/docs-new/rest/ua/modify-leverage-uta // contract uta
...
- https://exchange-broker.cexc.io/docs-new/rest/futures-trading/positions/modify-cross-margin-leverage
- https://exchange-broker.cexc.io/docs-new/rest/ua/modify-leverage-uta
...
```javascript
cexc.setContractLeverage (leverage, symbol, params?)
```
...
- https://exchange-broker.cexc.io/docs-new/rest/ua/get-current-funding-rate
- https://exchange-broker.cexc.io/docs-new/rest/futures-trading/funding-fees/get-current-funding-rate
...
```javascript
cexc.fetchFundingInterval (symbol, params?)
```
...
- https://exchange-broker.cexc.io/docs-new/rest/futures-trading/funding-fees/get-public-funding-history
- https://exchange-broker.cexc.io/docs-new/rest/ua/get-history-funding-rate
...
**See**: https://exchange-broker.cexc.io/docs-new/rest/futures-trading/funding-fees/get-private-funding-history  
...
```javascript
cexc.fetchFundingHistory (symbol, since?, limit?, params?)
```
...
- https://exchange-broker.cexc.io/docs-new/rest/futures-trading/positions/get-position-details
- https://exchange-broker.cexc.io/docs-new/rest/ua/get-position-list-uta
...
```javascript
cexc.fetchPosition (symbol, params?)
```
...
- https://exchange-broker.cexc.io/docs-new/rest/futures-trading/positions/get-position-list
- https://exchange-broker.cexc.io/docs-new/rest/ua/get-position-list-uta
...
```javascript
cexc.fetchPositions (symbols, params?)
```
...
- https://exchange-broker.cexc.io/docs-new/rest/futures-trading/positions/get-positions-history
- https://exchange-broker.cexc.io/docs-new/rest/ua/get-position-history-uta
...
```javascript
cexc.fetchPositionsHistory (symbols?, since?, limit?, params?)
```
...
- https://exchange-broker.cexc.io/docs-new/3470241e0
- https://exchange-broker.cexc.io/docs-new/rest/ua/batch-cancel-order-by-id
...
```javascript
cexc.cancelOrders (ids, symbol, params?)
```
...
**See**: https://exchange-broker.cexc.io/docs-new/rest/futures-trading/positions/add-isolated-margin  
...
```javascript
cexc.addMargin (symbol, amount, params?)
```
...
**See**: https://exchange-broker.cexc.io/docs-new/rest/futures-trading/positions/remove-isolated-margin  
...
```javascript
cexc.reduceMargin (symbol, amount, params?)
```
...
**See**: https://exchange-broker.cexc.io/docs-new/rest/futures-trading/positions/get-margin-mode  
...
```javascript
cexc.fetchMarginMode (symbol, params?)
```
...
**See**: https://exchange-broker.cexc.io/docs-new/rest/futures-trading/positions/switch-margin-mode  
...
```javascript
cexc.setMarginMode (marginMode, symbol, params?)
```
...
**See**: https://exchange-broker.cexc.io/docs-new/rest/futures-trading/positions/switch-position-mode  
...
```javascript
cexc.setPositionMode (hedged, symbol?, params?)
```
...
**See**: https://exchange-broker.cexc.io/docs-new/rest/futures-trading/positions/get-position-mode  
...
```javascript
cexc.fetchPositionMode (symbol?, params?)
```
...
```javascript
cexc.closePosition (symbol, side, params?)
```
...
**See**: https://exchange-broker.cexc.io/docs-new/rest/futures-trading/positions/get-isolated-margin-risk-limit  
...
```javascript
cexc.fetchMarketLeverageTiers (symbol, params?)
```
...
**See**: https://exchange-broker.cexc.io/docs-new/rest/ua/get-position-tiers  
...
```javascript
cexc.fetchLeverageTiers (symbols, params?)
```
...
**See**: https://exchange-broker.cexc.io/docs-new/rest/ua/get-futures-open-interset  
...
```javascript
cexc.fetchOpenInterests (symbols?, params?)
```
...
```javascript
cexc.fetchOpenInterestHistory (symbol, timeframe, since?, limit?, params?)
```
...
**See**: https://exchange-broker.cexc.io/docs-new/rest/ua/get-account-mode  
...
**See**: https://exchange-broker.cexc.io/docs-new/rest/account-info/account-funding/get-account-ledgers-spot-margin  
...
**See**: https://exchange-broker.cexc.io/docs-new/rest/futures-trading/positions/get-position-list  
...
```javascript
cexc.fetchPositionsADLRank (symbols?, params?)
```
...
```javascript
cexc.watchPosition (symbol, params)
```
...
```javascript
cexc.watchPositions (symbols?, since?, limit?, params)
```
...
```javascript
cexc.watchFundingRate (symbol, params?)
```
...
```javascript
cexc.unWatchFundingRate (symbol, params?)
```
...
```javascript
cexc.watchMarkPrice (symbol, params?)
```
...
```javascript
cexc.unWatchMarkPrice (symbol, params?)
```
